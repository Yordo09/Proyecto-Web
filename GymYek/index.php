...
<html>
	...
	<body>
		...
		<header>
			<div id="subheader">
				<div id="logotipo"><p><a href="#">Gimnasio Yek</a></p></div>
				<nav>
					<ul>
					...
					<article>
						...
						<p>
							<ul>
								...
								<li>+ Fusce aliquam erat a felis aliquam, vel viverra lectus cursus.</li>
								<li>+ Mauris semper orci vel facilisis porttitor.</li>
								<li>+ Nullam vitae dolor vel risus volutpat sagittis at at magna.</li>
								<li>+ Mauris luctus mauris bibendum, feugiat justo eget, luctus urna.</li>
							</ul>
						</p>
