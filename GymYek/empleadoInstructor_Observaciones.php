		...
		<section id="wrap">
			...
			<section id="main">
				...
				<section id="bienvenidos">
					<article>
						<hgroup><h2 align="center">Agregar Observaciones</h2></hgroup>
						<div align="center">
						<table width="50%" border="1" align="center">
						    <tr><form action="php/usuario.php" name="formCliente" method="post">
						    	<td>Observaciones: <input type="text" name="accion" value="updObs" hidden></input></td>
						    	<td><textarea rows="6" cols="40"  name="obs" required></textarea></td>
							</tr>
							<tr>
							...
							<tr>
								<td></td>
								<td><input type="submit" align="center" name="btnObs" value="Guardar"></td>
							</tr>
